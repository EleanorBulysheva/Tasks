...
public class Number1 {
    ...
    // Здравствуйте, меня зовут Бесси, и это мое эссе
    //Системы.из.код println ("Бесси" (А,Б,в));
    //int a=10;
    //int b=7;
    // String c= " Здравствуйте, меня зовут Бесси, и это мое эссе";

        public static String essay(int n, int k, String text) {
        String[] words = text.split(" ");//создается массив со словами
