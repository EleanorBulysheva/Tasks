...
public class Number3 {
    ...
    //Функция принимает два аргумента — собственно строку, и флаг,
    //указывающий писать результат с большой буквы (недо-camelCase).
    //Делает она всё это за один проход.
    //Где была большая буква меняем на маленькую и добовляем подчеркивание
    ...
    //После нижнего подчеркивания делаем с большой буквы
